...
def bmi_and_note(height_cm, weight_kg):
    ...
    # Devuelve (texto_valor, texto_categoria) o (None, None) si no procede.
...
def build_patient_context(row):
    ...
    # Extrae patient_id, sex, age, height, weight del Excel
...
def save_report_pdf(text_body: str, out_path: str, title: str, patient_block: str):
    # Reemplaza caracteres fuera de latin-1 
...
def main(args):
    ...
    if args.make_report:
        try:
            ...
            print("       ¿Está el servidor arrancado?  ->  ollama serve   y   ollama pull llama3:8b")
            print("Detalle:", e)
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        type=str,
        default="llama3:8b",  
        help="Nombre del modelo en Ollama o ruta al .gguf (llama_cpp).",
    )
    parser.add_argument(
        "--report_path",
        type=str,
